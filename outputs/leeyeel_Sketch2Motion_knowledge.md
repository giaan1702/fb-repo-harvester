# 📦 Tri Thức Kỹ Thuật Dự Án: leeyeel/Sketch2Motion

> **Mô tả ngắn**: convert photo or sketch to motion video

## 1. Nguồn Giới Thiệu & Video
- **Link bài viết / Video gốc**: [https://www.facebook.com/reel/1096912486614111](https://www.facebook.com/reel/1096912486614111)
- **Kênh / Người chia sẻ**: Cộng đồng Công Nghệ

## 2. Thông Tin Kho Mã Nguồn (GitHub Metadata)
- **GitHub URL**: [https://github.com/leeyeel/Sketch2Motion](https://github.com/leeyeel/Sketch2Motion)
- **Chỉ số cộng đồng**: ⭐ **349** stars | 🍴 **47** forks
- **Ngôn ngữ chủ đạo**: `Python`
- **Giấy phép bản quyền (License)**: `None`
- **Cập nhật gần nhất**: 2026-09-05T13:27:35Z
...
```bash
git clone https://github.com/leeyeel/Sketch2Motion
```
