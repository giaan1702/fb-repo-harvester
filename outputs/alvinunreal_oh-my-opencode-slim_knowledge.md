# 📦 Tri Thức Kỹ Thuật Dự Án: alvinunreal/oh-my-opencode-slim

> **Mô tả ngắn**: Lean, fine tuned Opencode multi agent suite · Mix any models · Auto delegate tasks

## 1. Nguồn Giới Thiệu & Video
- **Link bài viết / Video gốc**: [https://www.facebook.com/reel/1828882055141967](https://www.facebook.com/reel/1828882055141967)
- **Kênh / Người chia sẻ**: Lạch Cạch AI
- **Tiêu đề video**: 1500 token/s? Local AI vừa thay đổi cuộc chơi!

**Trích đoạn bài viết / Caption**:
```text
Qwen 3.8 27B trên Cerebras đạt 1500 token/s. Local-first không còn là giấc mơ.

#AI #LocalFirst #Qwen #Cerebras
```


## 2. Thông Tin Kho Mã Nguồn (GitHub Metadata)
- **GitHub URL**: [https://github.com/alvinunreal/oh-my-opencode-slim](https://github.com/alvinunreal/oh-my-opencode-slim)
- **Chỉ số cộng đồng**: ⭐ **8,646** stars | 🍴 **512** forks
- **Ngôn ngữ chủ đạo**: `TypeScript`
- **Giấy phép bản quyền (License)**: `MIT`
- **Chủ đề (Topics)**: `agentic-ai`, `antigravity`, `cerebras`, `herdr-plugin`, `oh-my-opencode`, `opencode`, `orchestration`
- **Cập nhật gần nhất**: 2026-09-05T17:03:57Z

## 💡 3. Nhận Định & Phân Loại Của AI
- **Phân Loại Lĩnh Vực**: `AI & Autonomous Agents`
- **Kiến Trúc Kỹ Thuật**: `Hệ thống phần mềm mã nguồn mở (TypeScript)`
