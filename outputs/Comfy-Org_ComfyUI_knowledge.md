# 📦 Tri Thức Kỹ Thuật Dự Án: Comfy-Org/ComfyUI

> **Mô tả ngắn**: The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
...
- **GitHub URL**: [https://github.com/Comfy-Org/ComfyUI](https://github.com/Comfy-Org/ComfyUI)
- **Chỉ số cộng đồng**: ⭐ **131,622** stars | 🍴 **15,515** forks
- **Ngôn ngữ chủ đạo**: `Python`
- **Giấy phép bản quyền (License)**: `GPL-3.0`
- **Chủ đề (Topics)**: `ai`, `comfy`, `comfyui`, `python`, `pytorch`, `stable-diffusion`
- **Cập nhật gần nhất**: 2026-09-05T15:58:37Z
...
```python
# Khởi chạy nhanh dự án ComfyUI
import sys
print('Đang nạp module ComfyUI...')
```
