# 📦 Tri Thức Kỹ Thuật Dự Án: jwasham/coding-interview-university

> **Mô tả ngắn**: A complete computer science study plan to become a software engineer.

## 1. Nguồn Giới Thiệu & Video
- **Link bài viết / Video gốc**: [https://www.facebook.com/reel/492927983523074](https://www.facebook.com/reel/492927983523074)
- **Kênh / Người chia sẻ**: Cộng đồng Công Nghệ

## 2. Thông Tin Kho Mã Nguồn (GitHub Metadata)
- **GitHub URL**: [https://github.com/jwasham/coding-interview-university](https://github.com/jwasham/coding-interview-university)
- **Chỉ số cộng đồng**: ⭐ **360,389** stars | 🍴 **84,805** forks
- **Ngôn ngữ chủ đạo**: `Unknown`
- **Giấy phép bản quyền (License)**: `CC-BY-SA-4.0`
- **Chủ đề (Topics)**: `algorithm`, `algorithms`, `coding-interview`, `coding-interviews`, `computer-science`, `data-structures`, `interview`, `interview-prep`, `interview-preparation`, `programming-interviews`, `software-engineering`, `study-plan`
- **Cập nhật gần nhất**: 2026-09-05T16:15:26Z

## 💡 3. Nhận Định & Phân Loại Của AI
- **Phân Loại Lĩnh Vực**: `Education, Cheatsheets & Resource Guides`
- **Kiến Trúc Kỹ Thuật**: `Static Documentation`
...
```
#!/bin/bash
# Hello World from Coding Interview University
 echo "Welcome to Coding Interview University!"
 echo "Start your study plan by opening the README.md file."
```
